...
public class Controller16 {
    ...
    public void method3(Model model, HttpSession session){
        ...
        System.out.println(System.identityHashCode(model));
    ...
    public String method14(RedirectAttributes rttr){
        rttr.addFlashAttribute("foodList",List.of("피자","햄버거","김밥"));
        // main16/sub15 요청할떄
        // foodList 라는 attribute를 꺼낼 수 있게 작성
