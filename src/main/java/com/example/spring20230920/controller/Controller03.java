...
public class Controller03 {
    ...
    // main2/sub?name=son&address=london
    @RequestMapping("sub2")
    ...
    //main2/sub5?email=abc@gmil.com&gender=남자&number=010-9999-9999
    @RequestMapping("sub5")
    ...
    public  void method10(@RequestParam(value = "address") String address,
    ...
    public  void method10(@RequestParam(value = "age",defaultValue ="0") Integer age){
