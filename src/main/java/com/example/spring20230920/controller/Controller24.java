...
//            statement.setString(2,"이");
//            statement.setString(3,"파리");
//            statement.setString(4,"영국");
//            statement.setString(5,"s-43");
//            statement.setString(6,"korea");
//            statement.setString(7,"010-0000-0000");
//           int cnt =  statement.executeUpdate();
//           if(cnt==1){
//               System.out.println("성공");
//           }else {
