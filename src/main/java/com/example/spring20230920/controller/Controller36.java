...
public class Controller36 {
    ...
    // axios.get("/main36/sub3",{params : {id:5}})
    /**
     *  axios.request({
     *    url : "/main36/sub3"
     *    method : "get"
    ...
    public void method(Integer id){
     Map<String,Object> data =  dao.selectByEmployeedId(id);
        System.out.println("data = " + data);
    }

    // post/main36/sub4
    // lastName =손&firstNam=흥민&birthDate=2020-02-02
    /*
...
//    axios.delete("/main36/sub11/5")
    ...
    * */
    ...
    public void method12(@PathVariable Integer pid){
        int a = dao.deleteByEmployeeId(pid);
        System.out.println(a + "  개  행 삭제 함");
    }
