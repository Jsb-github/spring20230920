...
<body>
    ...
    <div><input type="button" name="param4" value="어떤버튼"></div>
...
<%--        div*2>input:r--%>
        ...
        <div><input type="radio" name="param7" checked id=""></div>
...
<%--            div>div*3>label[for=check$]>lorem1^input:c#check$--%>
            <div>
                ...
                <div>
                    <label for="check2">Alias.</label>
                    <input type="checkbox" name="" id="check2">
                </div>
                <div>
                    <label for="check3">Iure?</label>
