...
<body>
            ...
            <script>
                    function ajax7(){
                        axios.get("/main38/sub2")
                            ...
                            .then(function (param){  // param 직전 실행한 함수에 리턴함 값
                                console.log('두번째 함수')
                                console.log(param)
                                return 345;
                            })
            ...
            <script>
                function ajax8(){
                    ...
                    .then(function () {
                            ...
                            .then(function (param) {
                                console.log("두번쨰 함수 일함.")
                                console.log(param)
                            })
                    }
            </script>
    </div>
                <%-- function fanme(param1,paramN) {
                        console.log()
    ...
    <script>
        ...
        console.log(category); // category변수에 값을 할당하지 않아서  undefined 반환
