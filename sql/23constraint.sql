...
VALUE (66); -- col2= null 허용 안해서 not ok
...
INSERT INTO my_table14(col1,col2)
    VALUE (11,33); -- col2= 중복된 값을 넣을수 없음  Not ok

INSERT INTO  my_table14(Col1)
VALUE (11); -- null은 값이 아니므로 col2 값 안넣어도 계속 사용가능
...
INSERT INTO my_table18(col1, col2, col3)
    VALUE(3,NULL,NULL); -- col3은 널값 허용 안하므로 not ok
